Feature:Tic-Tac-Toe Game Play
  Machine as the player plays against an opponent
  The machine can be "X" or "O" depends which player makes a move first

  Scenario: Start a new game as an X
